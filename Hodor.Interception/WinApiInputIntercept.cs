...
{
    public class WinApiInputIntercept
    {
        #region Delegates
        ...
        private static bool _isFromSendInput = false;
        private static LowLevelKeyboardProc _proc;
        private static int _index = 0;
        private static List<VirtualKeyShort> _hodor = new List<VirtualKeyShort>() 
            { 
                VirtualKeyShort.KEY_H, 
                VirtualKeyShort.KEY_O, 
                VirtualKeyShort.KEY_D, 
                VirtualKeyShort.KEY_O, 
        ...
        public void Unhook(IntPtr hookId)
        {
